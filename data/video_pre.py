...
class VideoDataset:
    ...
    def __init__(self, args, base_attrs):
        ...
        # video_feats_path = '/home/jiamengyao/TCL-MAP-main/Datasets/MIntRec2.0/video_data/video_feats.pkl'
        print(video_feats_path)
    ...
    def __padding(self, feat, video_max_length, padding_mode = 'zero', padding_loc = 'end'):
        ...
        #     return feat[video_max_length, :] # raw code if video_max_length=50 (83,256)->(1,256) get the 50th row
        
        # mintrec2.0
        if video_length > video_max_length:
            return feat[:video_max_length, :] # if video_max_length=50 (83,256)->(50,256) get the top 50 rows
    ...
    def __padding_feats(self, args, base_attrs):
        ...
        for dataset_type in self.feats.keys():
            ...
            for feat in feats:
                feat = np.array(feat)
                feat = feat.squeeze(1) if feat.shape[1] == 1 else feat
                ...
                length_list.append(min(len(feat), video_max_length))  

            padding_feats[dataset_type] = {
                'feats': tmp_list,
                'lengths': length_list
            }
