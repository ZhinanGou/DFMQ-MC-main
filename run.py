...
def parse_arguments():
    ...
    parser.add_argument('--logger_name', type=str, default='Multimodal Intent Recognition', help="Logger name for multimodal intent analysis.")
    ...
    # parser.add_argument("--data_path", default='/home/sharing/disk1', type=str, help="The input data dir. Should contain text, video and audio data for the task.")
    parser.add_argument("--data_path", default='/home/jiamengyao/TCL-MAP-main/Datasets', type=str, help="The input data dir. Should contain text, video and audio data for the task.")
    ...
    parser.add_argument('--video_feats_path', type=str, default='swin_feats.pkl', help="The directory of the video features.")  # swin_feats.pkl video_feats.pkl
    ...
    parser.add_argument('--method', type=str, default='mintood', help="which method to use (mult, misa, mag_bert, tcl-map sdif-da).")  # mag_bert mult

    # parser.add_argument("--text_backbone", type=str, default='bert-base-uncased', help="which backbone to use for the text modality.")  
    parser.add_argument("--text_backbone", type=str, default='/home/jiamengyao/MIntRec-main/bert-base-uncased', help="which backbone to use for the text modality.") 

    # parser.add_argument("--bert_base_uncased_path", type=str, default="bert-base-uncased", help="The name of the pre-trained BERT model to use.")  #
    parser.add_argument("--bert_base_uncased_path", type=str, default='/home/jiamengyao/MIntRec-main/bert-base-uncased'"", help="The name of the pre-trained BERT model to use.")  #

    parser.add_argument("--config_file_name", type=str, default='mintood_mintrec', help = "The name of the config file.")  # mag_bert_mintrec

    parser.add_argument("--aug", action="store_true", help="SDIF_MIntRec is True all others are False.")
